...
>(({ className, children, onClick, onPointerDown, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-4 top-[50%] z-50 mx-auto grid max-w-lg translate-y-[-50%]",
        "gap-4 overflow-hidden border border-border/50 bg-card/95 backdrop-blur-xl p-6 shadow-2xl",
