...
export const UNVERIFY_DISCRIMINATOR = 9
...
export function getUnverifyInstructionDataEncoder(): FixedSizeEncoder<UnverifyInstructionDataArgs> {
  return transformEncoder(getStructEncoder([["discriminator", getU8Encoder()]]), (value) => ({
    ...value,
    discriminator: UNVERIFY_DISCRIMINATOR,
  }))
}
...
> {
  return combineCodec(getUnverifyInstructionDataEncoder(), getUnverifyInstructionDataDecoder())
}
...
>(
  input: UnverifyInput<TAccountAsset, TAccountCreator>,
  config?: { programAddress?: TProgramAddress }
): UnverifyInstruction<TProgramAddress, TAccountAsset, TAccountCreator> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as UnverifyInstruction<TProgramAddress, TAccountAsset, TAccountCreator>)
}
