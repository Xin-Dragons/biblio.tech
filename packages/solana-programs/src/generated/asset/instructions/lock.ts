...
export const LOCK_DISCRIMINATOR = 5
...
export type LockInstructionData = { discriminator: number }
...
>(
  input: LockInput<TAccountAsset, TAccountSigner>,
  config?: { programAddress?: TProgramAddress }
): LockInstruction<TProgramAddress, TAccountAsset, TAccountSigner> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as LockInstruction<TProgramAddress, TAccountAsset, TAccountSigner>)
}
