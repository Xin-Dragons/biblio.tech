...
export type EditionArgs = { key: KeyArgs; parent: Address; edition: number | bigint }
...
export function decodeEdition<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getEditionDecoder())
}
