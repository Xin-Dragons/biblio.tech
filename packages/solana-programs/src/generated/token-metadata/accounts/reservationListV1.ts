...
export function getReservationListV1Codec(): Codec<ReservationListV1Args, ReservationListV1> {
  return combineCodec(getReservationListV1Encoder(), getReservationListV1Decoder())
}
...
): Account<ReservationListV1, TAddress> | MaybeAccount<ReservationListV1, TAddress> {
...
export async function fetchMaybeReservationListV1<TAddress extends string = string>(
  rpc: Parameters<typeof fetchEncodedAccount>[0],
  address: Address<TAddress>,
  config?: FetchAccountConfig
...
export async function fetchAllReservationListV1(
  ...
  const maybeAccounts = await fetchAllMaybeReservationListV1(rpc, addresses, config)
...
export async function fetchAllMaybeReservationListV1(
  ...
  return maybeAccounts.map((maybeAccount) => decodeReservationListV1(maybeAccount))
}
