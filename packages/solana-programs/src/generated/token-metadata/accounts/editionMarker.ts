...
export function getEditionMarkerCodec(): FixedSizeCodec<EditionMarkerArgs, EditionMarker> {
...
export function decodeEditionMarker<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getEditionMarkerDecoder())
}
...
export async function fetchAllEditionMarker(
  ...
  const maybeAccounts = await fetchAllMaybeEditionMarker(rpc, addresses, config)
