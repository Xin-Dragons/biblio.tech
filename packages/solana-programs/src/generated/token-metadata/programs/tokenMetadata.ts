...
> =
  ...
  | ({ instructionType: TokenMetadataInstruction.Utilize } & ParsedUtilizeInstruction<TProgram>)
  | ({
  ...
  | ({ instructionType: TokenMetadataInstruction.BurnNft } & ParsedBurnNftInstruction<TProgram>)
  | ({
  ...
  | ({ instructionType: TokenMetadataInstruction.Burn } & ParsedBurnInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Create } & ParsedCreateInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Mint } & ParsedMintInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Delegate } & ParsedDelegateInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Revoke } & ParsedRevokeInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Lock } & ParsedLockInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Unlock } & ParsedUnlockInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Migrate } & ParsedMigrateInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Transfer } & ParsedTransferInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Update } & ParsedUpdateInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Use } & ParsedUseInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Verify } & ParsedVerifyInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Unverify } & ParsedUnverifyInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Collect } & ParsedCollectInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Print } & ParsedPrintInstruction<TProgram>)
  | ({ instructionType: TokenMetadataInstruction.Resize } & ParsedResizeInstruction<TProgram>)
  | ({
