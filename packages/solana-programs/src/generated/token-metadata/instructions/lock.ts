...
import { getLockArgsDecoder, getLockArgsEncoder, type LockArgs, type LockArgsArgs } from "../types"
...
export function getLockInstructionDataCodec(): Codec<LockInstructionDataArgs, LockInstructionData> {
...
> {
  ...
  return Object.freeze({
    ...
    data: getLockInstructionDataEncoder().encode(args as LockInstructionDataArgs),
    programAddress,
  } as LockInstruction<
    TProgramAddress,
    TAccountAuthority,
