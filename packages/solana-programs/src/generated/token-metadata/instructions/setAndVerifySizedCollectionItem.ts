...
export function getSetAndVerifySizedCollectionItemDiscriminatorBytes() {
  return getU8Encoder().encode(SET_AND_VERIFY_SIZED_COLLECTION_ITEM_DISCRIMINATOR)
}
...
export type SetAndVerifySizedCollectionItemInstruction<
  ...
  TAccountCollectionMasterEditionAccount extends string | AccountMeta<string> = string,
  TAccountCollectionAuthorityRecord extends string | AccountMeta<string> | undefined = undefined,
...
export type SetAndVerifySizedCollectionItemInstructionData = { discriminator: number }

export type SetAndVerifySizedCollectionItemInstructionDataArgs = {}

export function getSetAndVerifySizedCollectionItemInstructionDataEncoder(): FixedSizeEncoder<SetAndVerifySizedCollectionItemInstructionDataArgs> {
...
export function getSetAndVerifySizedCollectionItemInstructionDataDecoder(): FixedSizeDecoder<SetAndVerifySizedCollectionItemInstructionData> {
  return getStructDecoder([["discriminator", getU8Decoder()]])
}

export function getSetAndVerifySizedCollectionItemInstructionDataCodec(): FixedSizeCodec<
...
>(
  ...
  return {
    ...
    data: getSetAndVerifySizedCollectionItemInstructionDataDecoder().decode(instruction.data),
  }
}
