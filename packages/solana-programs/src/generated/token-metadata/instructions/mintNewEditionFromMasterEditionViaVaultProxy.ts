...
export function getMintNewEditionFromMasterEditionViaVaultProxyDiscriminatorBytes() {
  return getU8Encoder().encode(MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_VAULT_PROXY_DISCRIMINATOR)
}
...
export type MintNewEditionFromMasterEditionViaVaultProxyInstruction<
  ...
  TAccountNewMetadataUpdateAuthority extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      TAccountNewMetadata extends string
        ...
        : TAccountNewMetadata,
      TAccountNewEdition extends string ? WritableAccount<TAccountNewEdition> : TAccountNewEdition,
      TAccountMasterEdition extends string
        ? WritableAccount<TAccountMasterEdition>
        : TAccountMasterEdition,
      TAccountNewMint extends string ? WritableAccount<TAccountNewMint> : TAccountNewMint,
      ...
      TAccountVaultAuthority extends string
        ? ReadonlySignerAccount<TAccountVaultAuthority> & AccountSignerMeta<TAccountVaultAuthority>
...
export function getMintNewEditionFromMasterEditionViaVaultProxyInstructionDataEncoder(): FixedSizeEncoder<MintNewEditionFromMasterEditionViaVaultProxyInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_VAULT_PROXY_DISCRIMINATOR,
    })
  )
}
...
> {
  ...
  const originalAccounts = {
    ...
    newMintAuthority: { value: input.newMintAuthority ?? null, isWritable: false },
    payer: { value: input.payer ?? null, isWritable: true },
    vaultAuthority: { value: input.vaultAuthority ?? null, isWritable: false },
    safetyDepositStore: { value: input.safetyDepositStore ?? null, isWritable: false },
    safetyDepositBox: { value: input.safetyDepositBox ?? null, isWritable: false },
    ...
    tokenVaultProgram: { value: input.tokenVaultProgram ?? null, isWritable: false },
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedMintNewEditionFromMasterEditionViaVaultProxyInstruction<TProgram, TAccountMetas> {
