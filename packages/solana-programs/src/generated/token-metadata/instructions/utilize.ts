...
export type UtilizeInstruction<
  ...
  TAccountUseAuthorityRecord extends string | AccountMeta<string> | undefined = undefined,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountUseAuthority extends string
        ? WritableSignerAccount<TAccountUseAuthority> & AccountSignerMeta<TAccountUseAuthority>
      ...
      ...(TAccountBurner extends undefined
        ? []
        : [TAccountBurner extends string ? ReadonlyAccount<TAccountBurner> : TAccountBurner]),
      ...TRemainingAccounts,
    ]
  >

export type UtilizeInstructionData = { discriminator: number; numberOfUses: bigint }
...
> {
  return combineCodec(getUtilizeInstructionDataEncoder(), getUtilizeInstructionDataDecoder())
}
...
> {
  ...
  const originalAccounts = {
    ...
    useAuthorityRecord: { value: input.useAuthorityRecord ?? null, isWritable: true },
  ...
  return Object.freeze({
    ...
    data: getUtilizeInstructionDataEncoder().encode(args as UtilizeInstructionDataArgs),
    programAddress,
