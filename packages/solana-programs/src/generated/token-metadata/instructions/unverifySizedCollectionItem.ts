...
export type UnverifySizedCollectionItemInstructionData = { discriminator: number }
...
>(
  ...
  return {
    ...
    data: getUnverifySizedCollectionItemInstructionDataDecoder().decode(instruction.data),
  }
}
