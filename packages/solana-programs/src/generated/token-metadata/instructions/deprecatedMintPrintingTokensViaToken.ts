...
export function getDeprecatedMintPrintingTokensViaTokenDiscriminatorBytes() {
  return getU8Encoder().encode(DEPRECATED_MINT_PRINTING_TOKENS_VIA_TOKEN_DISCRIMINATOR)
}
...
export type DeprecatedMintPrintingTokensViaTokenInstruction<
  ...
  TAccountOneTimePrintingAuthorizationMint extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountBurnAuthority extends string
        ? ReadonlySignerAccount<TAccountBurnAuthority> & AccountSignerMeta<TAccountBurnAuthority>
...
export type DeprecatedMintPrintingTokensViaTokenInstructionData = { discriminator: number }
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDeprecatedMintPrintingTokensViaTokenInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDeprecatedMintPrintingTokensViaTokenInstructionDataDecoder().decode(instruction.data),
  }
}
