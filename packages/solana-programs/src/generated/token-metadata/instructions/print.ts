...
export type PrintInstruction<
  ...
  TAccountEditionTokenAccountOwner extends string | AccountMeta<string> = string,
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountEdition extends string ? WritableAccount<TAccountEdition> : TAccountEdition,
...
export type PrintInstructionData = { discriminator: number; printArgs: PrintArgs }
...
> {
  return combineCodec(getPrintInstructionDataEncoder(), getPrintInstructionDataDecoder())
}
...
> {
  ...
  const originalAccounts = {
    ...
    editionTokenAccountOwner: { value: input.editionTokenAccountOwner ?? null, isWritable: false },
    editionTokenAccount: { value: input.editionTokenAccount ?? null, isWritable: true },
    editionMintAuthority: { value: input.editionMintAuthority ?? null, isWritable: false },
    editionTokenRecord: { value: input.editionTokenRecord ?? null, isWritable: true },
    masterEdition: { value: input.masterEdition ?? null, isWritable: true },
    editionMarkerPda: { value: input.editionMarkerPda ?? null, isWritable: true },
    payer: { value: input.payer ?? null, isWritable: true },
    masterTokenAccountOwner: { value: input.masterTokenAccountOwner ?? null, isWritable: false },
    masterTokenAccount: { value: input.masterTokenAccount ?? null, isWritable: false },
  ...
  return Object.freeze({
    ...
    data: getPrintInstructionDataEncoder().encode(args as PrintInstructionDataArgs),
    programAddress,
  } as PrintInstruction<
    TProgramAddress,
    TAccountEditionMetadata,
...
>(
  ...
  const getNextOptionalAccount = () => {
    ...
    return accountMeta.address === TOKEN_METADATA_PROGRAM_ADDRESS ? undefined : accountMeta
  }
  return {
