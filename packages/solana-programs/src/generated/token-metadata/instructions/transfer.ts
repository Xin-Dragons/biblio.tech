...
export type TransferInstruction<
  ...
  TAccountAuthorizationRulesProgram extends string | AccountMeta<string> = string,
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountTokenOwner extends string ? ReadonlyAccount<TAccountTokenOwner> : TAccountTokenOwner,
      ...
      TAccountEdition extends string ? ReadonlyAccount<TAccountEdition> : TAccountEdition,
...
export type TransferInstructionData = { discriminator: number; transferArgs: TransferArgs }
...
> {
  ...
  const originalAccounts = {
    ...
    destinationOwner: { value: input.destinationOwner ?? null, isWritable: false },
    ...
    authorizationRules: { value: input.authorizationRules ?? null, isWritable: false },
  }
