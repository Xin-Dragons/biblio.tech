...
export type VerifySizedCollectionItemInstructionData = { discriminator: number }
...
>(
  ...
  return {
    ...
    data: getVerifySizedCollectionItemInstructionDataDecoder().decode(instruction.data),
  }
}
