...
export type DeprecatedMintPrintingTokensInstructionData = { discriminator: number }
...
>(
  ...
  return {
    ...
    data: getDeprecatedMintPrintingTokensInstructionDataDecoder().decode(instruction.data),
  }
}
