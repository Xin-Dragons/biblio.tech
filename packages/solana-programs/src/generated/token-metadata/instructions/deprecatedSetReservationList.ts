  ...
  InstructionWithAccounts<
    [
      ...
      TAccountResource extends string
        ? ReadonlySignerAccount<TAccountResource> & AccountSignerMeta<TAccountResource>
        : TAccountResource,
      ...TRemainingAccounts,
    ]
  >

export type DeprecatedSetReservationListInstructionData = { discriminator: number }
...
>(
  ...
  return {
    ...
    data: getDeprecatedSetReservationListInstructionDataDecoder().decode(instruction.data),
  }
}
