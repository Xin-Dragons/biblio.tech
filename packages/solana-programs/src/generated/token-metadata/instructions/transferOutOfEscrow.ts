...
export type TransferOutOfEscrowInstruction<
  ...
  TAccountAuthority extends string | AccountMeta<string> | undefined = undefined,
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountEscrowMint extends string ? ReadonlyAccount<TAccountEscrowMint> : TAccountEscrowMint,
...
export type TransferOutOfEscrowInstructionData = { discriminator: number; amount: bigint }

export type TransferOutOfEscrowInstructionDataArgs = { amount: number | bigint }
...
export function getTransferOutOfEscrowInstructionDataEncoder(): FixedSizeEncoder<TransferOutOfEscrowInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: TRANSFER_OUT_OF_ESCROW_DISCRIMINATOR })
  )
}
...
>(
  ...
  return {
    ...
    data: getTransferOutOfEscrowInstructionDataDecoder().decode(instruction.data),
  }
}
