...
export type RevokeCollectionAuthorityInstructionData = { discriminator: number }
...
> {
  ...
  const originalAccounts = {
    ...
    delegateAuthority: { value: input.delegateAuthority ?? null, isWritable: true },
...
>(
  ...
  return {
    ...
    data: getRevokeCollectionAuthorityInstructionDataDecoder().decode(instruction.data),
  }
}
