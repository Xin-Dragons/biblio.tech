...
export type BurnEditionNftInstruction<
  ...
  TAccountPrintEditionTokenAccount extends string | AccountMeta<string> = string,
  TAccountMasterEditionTokenAccount extends string | AccountMeta<string> = string,
...
export function getBurnEditionNftInstructionDataEncoder(): FixedSizeEncoder<BurnEditionNftInstructionDataArgs> {
  return transformEncoder(getStructEncoder([["discriminator", getU8Encoder()]]), (value) => ({
    ...value,
    discriminator: BURN_EDITION_NFT_DISCRIMINATOR,
  }))
}
...
> {
  ...
  const originalAccounts = {
    ...
    printEditionMint: { value: input.printEditionMint ?? null, isWritable: true },
    masterEditionMint: { value: input.masterEditionMint ?? null, isWritable: false },
    printEditionTokenAccount: { value: input.printEditionTokenAccount ?? null, isWritable: true },
    masterEditionTokenAccount: {
      value: input.masterEditionTokenAccount ?? null,
      isWritable: false,
    },
    masterEditionAccount: { value: input.masterEditionAccount ?? null, isWritable: true },
    printEditionAccount: { value: input.printEditionAccount ?? null, isWritable: true },
    editionMarkerAccount: { value: input.editionMarkerAccount ?? null, isWritable: true },
