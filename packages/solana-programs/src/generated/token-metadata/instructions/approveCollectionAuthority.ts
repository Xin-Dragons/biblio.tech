...
export type ApproveCollectionAuthorityInstruction<
  ...
  TAccountCollectionAuthorityRecord extends string | AccountMeta<string> = string,
...
export type ApproveCollectionAuthorityInstructionData = { discriminator: number }
...
> {
  ...
  const originalAccounts = {
    collectionAuthorityRecord: { value: input.collectionAuthorityRecord ?? null, isWritable: true },
...
>(
  ...
  return {
    ...
    data: getApproveCollectionAuthorityInstructionDataDecoder().decode(instruction.data),
  }
}
