...
export type RemoveCreatorVerificationInstructionData = { discriminator: number }
...
>(
...
): RemoveCreatorVerificationInstruction<TProgramAddress, TAccountMetadata, TAccountCreator> {
  // Program address.
  ...
  return Object.freeze({
    accounts: [getAccountMeta(accounts.metadata), getAccountMeta(accounts.creator)],
    data: getRemoveCreatorVerificationInstructionDataEncoder().encode({}),
    programAddress,
  } as RemoveCreatorVerificationInstruction<TProgramAddress, TAccountMetadata, TAccountCreator>)
}
...
>(
  ...
  return {
    ...
    data: getRemoveCreatorVerificationInstructionDataDecoder().decode(instruction.data),
  }
}
