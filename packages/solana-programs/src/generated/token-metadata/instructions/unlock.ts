...
export type UnlockInstructionData = { discriminator: number; unlockArgs: UnlockArgs }
...
> {
  ...
  return Object.freeze({
    ...
    data: getUnlockInstructionDataEncoder().encode(args as UnlockInstructionDataArgs),
    programAddress,
