...
export function getVerifyCollectionInstructionDataEncoder(): FixedSizeEncoder<VerifyCollectionInstructionDataArgs> {
  return transformEncoder(getStructEncoder([["discriminator", getU8Encoder()]]), (value) => ({
    ...value,
    discriminator: VERIFY_COLLECTION_DISCRIMINATOR,
  }))
}

export function getVerifyCollectionInstructionDataDecoder(): FixedSizeDecoder<VerifyCollectionInstructionData> {
  return getStructDecoder([["discriminator", getU8Decoder()]])
}

export function getVerifyCollectionInstructionDataCodec(): FixedSizeCodec<
...
> {
  ...
  const originalAccounts = {
    ...
    collectionAuthority: { value: input.collectionAuthority ?? null, isWritable: true },
