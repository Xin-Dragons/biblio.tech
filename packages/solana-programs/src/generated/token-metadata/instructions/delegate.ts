...
export type DelegateInstructionData = { discriminator: number; delegateArgs: DelegateArgs }
...
> {
  return combineCodec(getDelegateInstructionDataEncoder(), getDelegateInstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getDelegateInstructionDataEncoder().encode(args as DelegateInstructionDataArgs),
    programAddress,
