...
export type UnverifyInstructionData = { discriminator: number; verificationArgs: VerificationArgs }

export type UnverifyInstructionDataArgs = { verificationArgs: VerificationArgsArgs }
...
> {
  ...
  return Object.freeze({
    ...
    data: getUnverifyInstructionDataEncoder().encode(args as UnverifyInstructionDataArgs),
    programAddress,
