...
export type ApproveUseAuthorityInstructionData = { discriminator: number; numberOfUses: bigint }

export type ApproveUseAuthorityInstructionDataArgs = { numberOfUses: number | bigint }
...
export function getApproveUseAuthorityInstructionDataEncoder(): FixedSizeEncoder<ApproveUseAuthorityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: APPROVE_USE_AUTHORITY_DISCRIMINATOR })
  )
}
...
>(
  ...
  return {
    ...
    data: getApproveUseAuthorityInstructionDataDecoder().decode(instruction.data),
  }
}
