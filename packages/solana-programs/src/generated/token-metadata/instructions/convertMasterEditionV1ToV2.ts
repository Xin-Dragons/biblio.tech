...
export type ConvertMasterEditionV1ToV2InstructionData = { discriminator: number }
...
>(
  ...
  return {
    ...
    data: getConvertMasterEditionV1ToV2InstructionDataDecoder().decode(instruction.data),
  }
}
