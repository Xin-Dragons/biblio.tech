...
export type DeprecatedCreateMasterEditionInstruction<
  ...
  TAccountOneTimePrintingAuthorizationMintAuthority extends string | AccountMeta<string> = string,
...
export type DeprecatedCreateMasterEditionInstructionData = { discriminator: number }
...
> {
  ...
  const originalAccounts = {
    ...
    printingMintAuthority: { value: input.printingMintAuthority ?? null, isWritable: false },
...
>(
  ...
  return {
    ...
    data: getDeprecatedCreateMasterEditionInstructionDataDecoder().decode(instruction.data),
  }
}
