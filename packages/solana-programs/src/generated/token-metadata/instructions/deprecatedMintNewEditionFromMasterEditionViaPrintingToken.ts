...
export type DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstruction<
  ...
  TAccountReservationList extends string | AccountMeta<string> | undefined = undefined,
...
export function getDeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionDataEncoder(): FixedSizeEncoder<DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionDataArgs> {
  return transformEncoder(getStructEncoder([["discriminator", getU8Encoder()]]), (value) => ({
    ...value,
    discriminator: DEPRECATED_MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_PRINTING_TOKEN_DISCRIMINATOR,
  }))
}
...
> {
  ...
  const originalAccounts = {
    ...
    masterTokenAccount: { value: input.masterTokenAccount ?? null, isWritable: true },
    ...
    masterUpdateAuthority: { value: input.masterUpdateAuthority ?? null, isWritable: false },
