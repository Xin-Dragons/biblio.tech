...
export function getDeprecatedCreateReservationListDiscriminatorBytes() {
  return getU8Encoder().encode(DEPRECATED_CREATE_RESERVATION_LIST_DISCRIMINATOR)
}
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountResource extends string ? ReadonlyAccount<TAccountResource> : TAccountResource,
...
export type DeprecatedCreateReservationListInstructionData = { discriminator: number }
...
>(
  ...
  return {
    ...
    data: getDeprecatedCreateReservationListInstructionDataDecoder().decode(instruction.data),
  }
}
