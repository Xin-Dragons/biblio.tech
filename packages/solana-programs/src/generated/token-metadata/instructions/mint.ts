...
import { getMintArgsDecoder, getMintArgsEncoder, type MintArgs, type MintArgsArgs } from "../types"
...
export function getMintInstructionDataCodec(): Codec<MintInstructionDataArgs, MintInstructionData> {
  return combineCodec(getMintInstructionDataEncoder(), getMintInstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getMintInstructionDataEncoder().encode(args as MintInstructionDataArgs),
    programAddress,
  } as MintInstruction<
    TProgramAddress,
    TAccountToken,
