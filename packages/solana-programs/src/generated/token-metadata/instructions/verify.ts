...
export type VerifyInstructionData = { discriminator: number; verificationArgs: VerificationArgs }

export type VerifyInstructionDataArgs = { verificationArgs: VerificationArgsArgs }
...
> {
  ...
  const originalAccounts = {
    ...
    collectionMetadata: { value: input.collectionMetadata ?? null, isWritable: true },
    collectionMasterEdition: { value: input.collectionMasterEdition ?? null, isWritable: false },
  ...
  return Object.freeze({
    ...
    data: getVerifyInstructionDataEncoder().encode(args as VerifyInstructionDataArgs),
    programAddress,
