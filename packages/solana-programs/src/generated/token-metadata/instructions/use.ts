...
import { getUseArgsDecoder, getUseArgsEncoder, type UseArgs, type UseArgsArgs } from "../types"
...
export function getUseInstructionDataCodec(): Codec<UseInstructionDataArgs, UseInstructionData> {
  return combineCodec(getUseInstructionDataEncoder(), getUseInstructionDataDecoder())
}
