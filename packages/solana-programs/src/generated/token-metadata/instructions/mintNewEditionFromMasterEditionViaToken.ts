...
export function getMintNewEditionFromMasterEditionViaTokenDiscriminatorBytes() {
  return getU8Encoder().encode(MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_TOKEN_DISCRIMINATOR)
}
...
export function getMintNewEditionFromMasterEditionViaTokenInstructionDataEncoder(): FixedSizeEncoder<MintNewEditionFromMasterEditionViaTokenInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_TOKEN_DISCRIMINATOR,
    })
  )
}
...
> {
  ...
  const originalAccounts = {
    ...
    tokenAccountOwner: { value: input.tokenAccountOwner ?? null, isWritable: false },
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedMintNewEditionFromMasterEditionViaTokenInstruction<TProgram, TAccountMetas> {
