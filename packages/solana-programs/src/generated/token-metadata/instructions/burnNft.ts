...
export type BurnNftInstruction<
  ...
  TAccountCollectionMetadata extends string | AccountMeta<string> | undefined = undefined,
...
export function getBurnNftInstructionDataEncoder(): FixedSizeEncoder<BurnNftInstructionDataArgs> {
  return transformEncoder(getStructEncoder([["discriminator", getU8Encoder()]]), (value) => ({
    ...value,
    discriminator: BURN_NFT_DISCRIMINATOR,
  }))
}
...
> {
  return combineCodec(getBurnNftInstructionDataEncoder(), getBurnNftInstructionDataDecoder())
}
