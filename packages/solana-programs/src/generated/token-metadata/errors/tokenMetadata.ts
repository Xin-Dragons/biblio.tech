...
export const TOKEN_METADATA_ERROR__EXPECTED_UNINITIALIZED_ACCOUNT = 0xc7 // 199
/** InvalidEditionAccountLength: Edition account has an invalid length */
export const TOKEN_METADATA_ERROR__INVALID_EDITION_ACCOUNT_LENGTH = 0xc8 // 200
/** AccountAlreadyResized: Account has already been resized */
export const TOKEN_METADATA_ERROR__ACCOUNT_ALREADY_RESIZED = 0xc9 // 201
/** ConditionsForClosingNotMet: Conditions for closing not met */
export const TOKEN_METADATA_ERROR__CONDITIONS_FOR_CLOSING_NOT_MET = 0xca // 202

export type TokenMetadataError =
  | typeof TOKEN_METADATA_ERROR__ACCOUNT_ALREADY_RESIZED
  ...
  | typeof TOKEN_METADATA_ERROR__CONDITIONS_FOR_CLOSING_NOT_MET
  ...
  | typeof TOKEN_METADATA_ERROR__EXPECTED_UNINITIALIZED_ACCOUNT
  ...
  | typeof TOKEN_METADATA_ERROR__INVALID_EDITION_ACCOUNT_LENGTH
...
export function getTokenMetadataErrorMessage(code: TokenMetadataError): string {
  if (process.env.NODE_ENV !== "production") {
    return (tokenMetadataErrorMessages as Record<TokenMetadataError, string>)[code]
  }

  return "Error message not available in production bundles."
}

export function isTokenMetadataError<TProgramErrorCode extends TokenMetadataError>(
  error: unknown,
