...
export type DelegateArgs =
  ...
  | { __kind: "SaleV1"; amount: bigint; authorizationData: Option<AuthorizationData> }
  | { __kind: "TransferV1"; amount: bigint; authorizationData: Option<AuthorizationData> }
  | { __kind: "DataV1"; authorizationData: Option<AuthorizationData> }
  | { __kind: "UtilityV1"; amount: bigint; authorizationData: Option<AuthorizationData> }
  | { __kind: "StakingV1"; amount: bigint; authorizationData: Option<AuthorizationData> }
  ...
  | { __kind: "ProgrammableConfigV1"; authorizationData: Option<AuthorizationData> }
  ...
  | { __kind: "ProgrammableConfigItemV1"; authorizationData: Option<AuthorizationData> }
  | { __kind: "PrintDelegateV1"; authorizationData: Option<AuthorizationData> }

export type DelegateArgsArgs =
  | { __kind: "CollectionV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
  | {
      __kind: "SaleV1"
  ...
  | { __kind: "DataV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
  | {
      __kind: "UtilityV1"
      amount: number | bigint
      authorizationData: OptionOrNullable<AuthorizationDataArgs>
  ...
  | { __kind: "ProgrammableConfigV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
  | { __kind: "AuthorityItemV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
  | { __kind: "DataItemV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
  | { __kind: "CollectionItemV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
  | {
      __kind: "ProgrammableConfigItemV1"
      authorizationData: OptionOrNullable<AuthorizationDataArgs>
    }
  | { __kind: "PrintDelegateV1"; authorizationData: OptionOrNullable<AuthorizationDataArgs> }
