...
export function getUsesToggleEncoder(): Encoder<UsesToggleArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    ["Set", getStructEncoder([["fields", getTupleEncoder([getUsesEncoder()])]])],
  ])
}
...
export function getUsesToggleDecoder(): Decoder<UsesToggle> {
  return getDiscriminatedUnionDecoder([
    ...
    ["Set", getStructDecoder([["fields", getTupleDecoder([getUsesDecoder()])]])],
  ])
}
...
export function usesToggle(
  kind: "Set",
  data: GetDiscriminatedUnionVariantContent<UsesToggleArgs, "__kind", "Set">["fields"]
): GetDiscriminatedUnionVariant<UsesToggleArgs, "__kind", "Set">
export function usesToggle<K extends UsesToggleArgs["__kind"], Data>(kind: K, data?: Data) {
