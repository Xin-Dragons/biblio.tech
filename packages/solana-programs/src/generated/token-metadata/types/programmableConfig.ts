...
export type ProgrammableConfigArgs = { __kind: "V1"; ruleSet: OptionOrNullable<Address> }

export function getProgrammableConfigEncoder(): Encoder<ProgrammableConfigArgs> {
  return getDiscriminatedUnionEncoder([
    ["V1", getStructEncoder([["ruleSet", getOptionEncoder(getAddressEncoder())]])],
  ])
}

export function getProgrammableConfigDecoder(): Decoder<ProgrammableConfig> {
  return getDiscriminatedUnionDecoder([
    ["V1", getStructDecoder([["ruleSet", getOptionDecoder(getAddressDecoder())]])],
  ])
}
...
export function programmableConfig<K extends ProgrammableConfigArgs["__kind"], Data>(
  kind: K,
  data?: Data
) {
