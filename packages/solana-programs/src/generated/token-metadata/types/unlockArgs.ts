...
export type UnlockArgs = { __kind: "V1"; authorizationData: Option<AuthorizationData> }
...
export function unlockArgs<K extends UnlockArgsArgs["__kind"], Data>(kind: K, data?: Data) {
