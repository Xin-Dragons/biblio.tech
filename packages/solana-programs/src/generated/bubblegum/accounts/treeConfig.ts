...
export const TREE_CONFIG_DISCRIMINATOR = new Uint8Array([122, 245, 175, 248, 171, 34, 0, 207])
...
export function getTreeConfigCodec(): FixedSizeCodec<TreeConfigArgs, TreeConfig> {
...
export function decodeTreeConfig<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getTreeConfigDecoder())
}
