...
export const VOUCHER_DISCRIMINATOR = new Uint8Array([191, 204, 149, 234, 213, 165, 13, 65])
...
export type VoucherArgs = { leafSchema: LeafSchemaArgs; index: number; merkleTree: Address }
...
/** Gets the decoder for {@link Voucher} account data. */
...
/** Gets the codec for {@link Voucher} account data. */
...
export function decodeVoucher<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getVoucherDecoder())
}
