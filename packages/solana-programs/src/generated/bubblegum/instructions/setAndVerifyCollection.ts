...
export const SET_AND_VERIFY_COLLECTION_DISCRIMINATOR = new Uint8Array([
  235, 242, 121, 216, 158, 234, 180, 234,
])

export function getSetAndVerifyCollectionDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SET_AND_VERIFY_COLLECTION_DISCRIMINATOR)
}
...
export function getSetAndVerifyCollectionInstructionDataEncoder(): Encoder<SetAndVerifyCollectionInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: SET_AND_VERIFY_COLLECTION_DISCRIMINATOR })
  )
}
...
>(
  ...
  return {
    ...
    data: getSetAndVerifyCollectionInstructionDataDecoder().decode(instruction.data),
  }
}
