...
export const VERIFY_COLLECTION_DISCRIMINATOR = new Uint8Array([56, 113, 101, 253, 79, 55, 122, 169])

export function getVerifyCollectionDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VERIFY_COLLECTION_DISCRIMINATOR)
}
