...
export const FREEZE_V2_DISCRIMINATOR = new Uint8Array([200, 151, 244, 102, 16, 195, 255, 3])
...
> {
  return combineCodec(getFreezeV2InstructionDataEncoder(), getFreezeV2InstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getFreezeV2InstructionDataEncoder().encode(args as FreezeV2InstructionDataArgs),
    programAddress,
