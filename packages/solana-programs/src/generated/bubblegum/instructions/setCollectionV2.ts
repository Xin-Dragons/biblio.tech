...
export const SET_COLLECTION_V2_DISCRIMINATOR = new Uint8Array([229, 35, 61, 91, 15, 14, 99, 160])

export function getSetCollectionV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SET_COLLECTION_V2_DISCRIMINATOR)
}
...
> {
  ...
  const originalAccounts = {
    ...
    newCollectionAuthority: { value: input.newCollectionAuthority ?? null, isWritable: false },
    ...
    newCoreCollection: { value: input.newCoreCollection ?? null, isWritable: true },
