...
export const BURN_V2_DISCRIMINATOR = new Uint8Array([115, 210, 34, 240, 232, 143, 183, 16])
...
> {
  return combineCodec(getBurnV2InstructionDataEncoder(), getBurnV2InstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getBurnV2InstructionDataEncoder().encode(args as BurnV2InstructionDataArgs),
    programAddress,
