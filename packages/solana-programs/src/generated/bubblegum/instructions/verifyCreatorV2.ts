...
export const VERIFY_CREATOR_V2_DISCRIMINATOR = new Uint8Array([85, 138, 140, 42, 22, 241, 118, 102])

export function getVerifyCreatorV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VERIFY_CREATOR_V2_DISCRIMINATOR)
}
