...
export const CREATE_TREE_V2_DISCRIMINATOR = new Uint8Array([55, 99, 95, 215, 142, 203, 227, 205])

export function getCreateTreeV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(CREATE_TREE_V2_DISCRIMINATOR)
}
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountTreeCreator extends string
        ? ReadonlySignerAccount<TAccountTreeCreator> & AccountSignerMeta<TAccountTreeCreator>
        : TAccountTreeCreator,
...
> {
  ...
  return Object.freeze({
    ...
    data: getCreateTreeV2InstructionDataEncoder().encode(args as CreateTreeV2InstructionDataArgs),
    programAddress,
