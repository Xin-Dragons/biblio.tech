...
export const UPDATE_METADATA_DISCRIMINATOR = new Uint8Array([170, 182, 43, 239, 97, 78, 225, 186])

export function getUpdateMetadataDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(UPDATE_METADATA_DISCRIMINATOR)
}
