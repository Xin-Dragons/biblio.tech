...
export const MINT_V2_DISCRIMINATOR = new Uint8Array([120, 121, 23, 146, 173, 110, 199, 205])
...
export function getMintV2InstructionDataEncoder(): Encoder<MintV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["assetData", getOptionEncoder(addEncoderSizePrefix(getBytesEncoder(), getU32Encoder()))],
...
export function getMintV2InstructionDataDecoder(): Decoder<MintV2InstructionData> {
  return getStructDecoder([
    ...
    ["assetData", getOptionDecoder(addDecoderSizePrefix(getBytesDecoder(), getU32Decoder()))],
...
> {
  ...
  return Object.freeze({
    ...
    data: getMintV2InstructionDataEncoder().encode(args as MintV2InstructionDataArgs),
    programAddress,
