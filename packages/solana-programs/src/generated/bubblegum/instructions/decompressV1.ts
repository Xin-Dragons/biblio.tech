...
export const DECOMPRESS_V1_DISCRIMINATOR = new Uint8Array([54, 85, 76, 70, 228, 250, 164, 81])

export function getDecompressV1DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DECOMPRESS_V1_DISCRIMINATOR)
}
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountSysvarRent extends string ? ReadonlyAccount<TAccountSysvarRent> : TAccountSysvarRent,
