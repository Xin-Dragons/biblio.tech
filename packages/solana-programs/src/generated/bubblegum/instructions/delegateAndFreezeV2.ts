...
export function getDelegateAndFreezeV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DELEGATE_AND_FREEZE_V2_DISCRIMINATOR)
}
...
export function getDelegateAndFreezeV2InstructionDataEncoder(): Encoder<DelegateAndFreezeV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DELEGATE_AND_FREEZE_V2_DISCRIMINATOR })
  )
}
...
>(
  ...
  return {
    ...
    data: getDelegateAndFreezeV2InstructionDataDecoder().decode(instruction.data),
  }
}
