...
export const CREATE_TREE_DISCRIMINATOR = new Uint8Array([165, 83, 136, 142, 89, 202, 47, 220])
...
> {
  return combineCodec(getCreateTreeInstructionDataEncoder(), getCreateTreeInstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getCreateTreeInstructionDataEncoder().encode(args as CreateTreeInstructionDataArgs),
    programAddress,
