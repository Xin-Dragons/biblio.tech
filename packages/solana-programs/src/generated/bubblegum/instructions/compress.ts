...
export const COMPRESS_DISCRIMINATOR = new Uint8Array([82, 193, 176, 117, 176, 21, 115, 253])
...
> {
  return combineCodec(getCompressInstructionDataEncoder(), getCompressInstructionDataDecoder())
}
