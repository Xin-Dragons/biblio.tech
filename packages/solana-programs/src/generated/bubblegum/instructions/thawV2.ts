...
export const THAW_V2_DISCRIMINATOR = new Uint8Array([96, 133, 101, 93, 82, 220, 146, 191])
...
export function getThawV2InstructionDataEncoder(): Encoder<ThawV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: THAW_V2_DISCRIMINATOR })
  )
}
...
> {
  return combineCodec(getThawV2InstructionDataEncoder(), getThawV2InstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getThawV2InstructionDataEncoder().encode(args as ThawV2InstructionDataArgs),
    programAddress,
