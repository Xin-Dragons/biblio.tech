...
export function getSetNonTransferableV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SET_NON_TRANSFERABLE_V2_DISCRIMINATOR)
}
...
export function getSetNonTransferableV2InstructionDataEncoder(): Encoder<SetNonTransferableV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: SET_NON_TRANSFERABLE_V2_DISCRIMINATOR })
  )
}
...
>(
  ...
  return {
    ...
    data: getSetNonTransferableV2InstructionDataDecoder().decode(instruction.data),
  }
}
