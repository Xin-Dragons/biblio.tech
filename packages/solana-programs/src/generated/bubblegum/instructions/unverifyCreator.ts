...
export const UNVERIFY_CREATOR_DISCRIMINATOR = new Uint8Array([107, 178, 57, 39, 105, 115, 112, 152])

export function getUnverifyCreatorDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(UNVERIFY_CREATOR_DISCRIMINATOR)
}
