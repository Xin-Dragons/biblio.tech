...
export const SET_TREE_DELEGATE_DISCRIMINATOR = new Uint8Array([253, 118, 66, 37, 190, 49, 154, 102])

export function getSetTreeDelegateDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SET_TREE_DELEGATE_DISCRIMINATOR)
}
...
export type SetTreeDelegateInstructionData = { discriminator: ReadonlyUint8Array }
...
> {
  ...
  const originalAccounts = {
    ...
    newTreeDelegate: { value: input.newTreeDelegate ?? null, isWritable: false },
