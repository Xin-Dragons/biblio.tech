...
export const VERIFY_CREATOR_DISCRIMINATOR = new Uint8Array([52, 17, 96, 132, 71, 4, 85, 194])

export function getVerifyCreatorDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VERIFY_CREATOR_DISCRIMINATOR)
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getVerifyCreatorInstructionDataEncoder().encode(args as VerifyCreatorInstructionDataArgs),
    programAddress,
