...
export function getMintToCollectionV1DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MINT_TO_COLLECTION_V1_DISCRIMINATOR)
}
...
export type MintToCollectionV1Instruction<
  ...
  TAccountCollectionAuthorityRecordPda extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountTreeDelegate extends string
        ? ReadonlySignerAccount<TAccountTreeDelegate> & AccountSignerMeta<TAccountTreeDelegate>
...
export type MintToCollectionV1InstructionDataArgs = { metadataArgs: MetadataArgsArgs }
...
export function getMintToCollectionV1InstructionDataEncoder(): Encoder<MintToCollectionV1InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: MINT_TO_COLLECTION_V1_DISCRIMINATOR })
  )
}
...
> {
  ...
  const originalAccounts = {
    ...
    bubblegumSigner: { value: input.bubblegumSigner ?? null, isWritable: false },
...
>(
  ...
  return {
    ...
    data: getMintToCollectionV1InstructionDataDecoder().decode(instruction.data),
  }
}
