...
export const CANCEL_REDEEM_DISCRIMINATOR = new Uint8Array([111, 76, 232, 50, 39, 175, 48, 242])

export function getCancelRedeemDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(CANCEL_REDEEM_DISCRIMINATOR)
}
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountLeafOwner extends string
        ? WritableSignerAccount<TAccountLeafOwner> & AccountSignerMeta<TAccountLeafOwner>
        : TAccountLeafOwner,
      TAccountMerkleTree extends string ? WritableAccount<TAccountMerkleTree> : TAccountMerkleTree,
      TAccountVoucher extends string ? WritableAccount<TAccountVoucher> : TAccountVoucher,
...
> {
  ...
  return Object.freeze({
    ...
    data: getCancelRedeemInstructionDataEncoder().encode(args as CancelRedeemInstructionDataArgs),
    programAddress,
