...
export const UPDATE_ASSET_DATA_V2_DISCRIMINATOR = new Uint8Array([59, 56, 111, 43, 95, 14, 11, 61])

export function getUpdateAssetDataV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(UPDATE_ASSET_DATA_V2_DISCRIMINATOR)
}
...
export function getUpdateAssetDataV2InstructionDataEncoder(): Encoder<UpdateAssetDataV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["previousAssetDataHash", getOptionEncoder(fixEncoderSize(getBytesEncoder(), 32))],
      ["flags", getOptionEncoder(getU8Encoder())],
      ["nonce", getU64Encoder()],
      ["index", getU32Encoder()],
      ["newAssetData", getOptionEncoder(addEncoderSizePrefix(getBytesEncoder(), getU32Encoder()))],
      ["newAssetDataSchema", getOptionEncoder(getAssetDataSchemaEncoder())],
    ]),
    (value) => ({ ...value, discriminator: UPDATE_ASSET_DATA_V2_DISCRIMINATOR })
  )
}
...
export function getUpdateAssetDataV2InstructionDataDecoder(): Decoder<UpdateAssetDataV2InstructionData> {
  return getStructDecoder([
    ...
    ["previousAssetDataHash", getOptionDecoder(fixDecoderSize(getBytesDecoder(), 32))],
    ["flags", getOptionDecoder(getU8Decoder())],
    ["nonce", getU64Decoder()],
    ["index", getU32Decoder()],
    ["newAssetData", getOptionDecoder(addDecoderSizePrefix(getBytesDecoder(), getU32Decoder()))],
