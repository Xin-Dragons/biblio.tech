...
export function getSetDecompressibleStateInstructionDataEncoder(): FixedSizeEncoder<SetDecompressibleStateInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: SET_DECOMPRESSIBLE_STATE_DISCRIMINATOR })
  )
}
...
>(
  ...
  return Object.freeze({
    accounts: [getAccountMeta(accounts.treeAuthority), getAccountMeta(accounts.treeCreator)],
...
>(
  ...
  return {
    ...
    accounts: { treeAuthority: getNextAccount(), treeCreator: getNextAccount() },
