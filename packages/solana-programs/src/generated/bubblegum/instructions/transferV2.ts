...
export const TRANSFER_V2_DISCRIMINATOR = new Uint8Array([119, 40, 6, 235, 234, 221, 248, 49])
...
> {
  return combineCodec(getTransferV2InstructionDataEncoder(), getTransferV2InstructionDataDecoder())
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getTransferV2InstructionDataEncoder().encode(args as TransferV2InstructionDataArgs),
    programAddress,
