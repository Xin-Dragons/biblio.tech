...
export const UPDATE_METADATA_V2_DISCRIMINATOR = new Uint8Array([43, 103, 89, 42, 121, 242, 62, 72])

export function getUpdateMetadataV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(UPDATE_METADATA_V2_DISCRIMINATOR)
}
