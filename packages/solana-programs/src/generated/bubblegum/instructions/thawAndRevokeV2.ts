...
export const THAW_AND_REVOKE_V2_DISCRIMINATOR = new Uint8Array([86, 214, 190, 37, 167, 4, 28, 116])

export function getThawAndRevokeV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(THAW_AND_REVOKE_V2_DISCRIMINATOR)
}
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountLeafDelegate extends string
        ? ReadonlySignerAccount<TAccountLeafDelegate> & AccountSignerMeta<TAccountLeafDelegate>
