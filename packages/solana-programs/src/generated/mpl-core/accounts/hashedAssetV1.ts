...
export function getHashedAssetV1Codec(): FixedSizeCodec<HashedAssetV1Args, HashedAssetV1> {
...
export function decodeHashedAssetV1<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getHashedAssetV1Decoder())
}
