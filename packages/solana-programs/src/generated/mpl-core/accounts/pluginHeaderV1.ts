...
export type PluginHeaderV1Args = { key: KeyArgs; pluginRegistryOffset: number | bigint }
...
export function getPluginHeaderV1Codec(): FixedSizeCodec<PluginHeaderV1Args, PluginHeaderV1> {
...
export function decodePluginHeaderV1<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getPluginHeaderV1Decoder())
}
...
export async function fetchMaybePluginHeaderV1<TAddress extends string = string>(
  rpc: Parameters<typeof fetchEncodedAccount>[0],
  address: Address<TAddress>,
  config?: FetchAccountConfig
