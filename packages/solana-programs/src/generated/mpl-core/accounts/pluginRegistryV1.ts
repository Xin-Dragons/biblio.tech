...
export function getPluginRegistryV1Codec(): Codec<PluginRegistryV1Args, PluginRegistryV1> {
...
): Account<PluginRegistryV1, TAddress> | MaybeAccount<PluginRegistryV1, TAddress> {
...
export async function fetchMaybePluginRegistryV1<TAddress extends string = string>(
  rpc: Parameters<typeof fetchEncodedAccount>[0],
  address: Address<TAddress>,
  config?: FetchAccountConfig
