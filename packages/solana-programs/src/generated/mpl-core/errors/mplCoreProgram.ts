...
let mplCoreProgramErrorMessages: Record<MplCoreProgramError, string> | undefined
...
export function getMplCoreProgramErrorMessage(code: MplCoreProgramError): string {
  if (process.env.NODE_ENV !== "production") {
    return (mplCoreProgramErrorMessages as Record<MplCoreProgramError, string>)[code]
  }

  return "Error message not available in production bundles."
}

export function isMplCoreProgramError<TProgramErrorCode extends MplCoreProgramError>(
  error: unknown,
