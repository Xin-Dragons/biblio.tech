...
> =
  | ({ instructionType: MplCoreProgramInstruction.CreateV1 } & ParsedCreateV1Instruction<TProgram>)
  | ({
  ...
  | ({ instructionType: MplCoreProgramInstruction.BurnV1 } & ParsedBurnV1Instruction<TProgram>)
  | ({
  ...
  | ({ instructionType: MplCoreProgramInstruction.UpdateV1 } & ParsedUpdateV1Instruction<TProgram>)
  | ({
  ...
  | ({ instructionType: MplCoreProgramInstruction.Collect } & ParsedCollectInstruction<TProgram>)
  | ({ instructionType: MplCoreProgramInstruction.CreateV2 } & ParsedCreateV2Instruction<TProgram>)
  | ({
  ...
  | ({ instructionType: MplCoreProgramInstruction.UpdateV2 } & ParsedUpdateV2Instruction<TProgram>)
  | ({
