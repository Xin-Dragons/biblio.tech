  ...
  InstructionWithAccounts<
    [
      TAccountCollection extends string
        ? WritableSignerAccount<TAccountCollection> & AccountSignerMeta<TAccountCollection>
        : TAccountCollection,
  ...
  return transformEncoder(
    getStructEncoder([
      ...
      [
        ...
        getOptionEncoder(getArrayEncoder(getExternalPluginAdapterInitInfoEncoder())),
      ],
    ]),
    (value) => ({ ...value, discriminator: CREATE_COLLECTION_V2_DISCRIMINATOR })
  )
}
...
export function getCreateCollectionV2InstructionDataDecoder(): Decoder<CreateCollectionV2InstructionData> {
  return getStructDecoder([
    ...
    [
      "externalPluginAdapters",
      getOptionDecoder(getArrayDecoder(getExternalPluginAdapterInitInfoDecoder())),
    ],
  ])
}
