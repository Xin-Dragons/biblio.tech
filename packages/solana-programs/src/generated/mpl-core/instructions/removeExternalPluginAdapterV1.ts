...
export type RemoveExternalPluginAdapterV1InstructionDataArgs = { key: ExternalPluginAdapterKeyArgs }
...
export function getRemoveExternalPluginAdapterV1InstructionDataEncoder(): Encoder<RemoveExternalPluginAdapterV1InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REMOVE_EXTERNAL_PLUGIN_ADAPTER_V1_DISCRIMINATOR })
  )
}
