...
export type RevokeCollectionPluginAuthorityV1InstructionDataArgs = { pluginType: PluginTypeArgs }
...
export function getRevokeCollectionPluginAuthorityV1InstructionDataEncoder(): FixedSizeEncoder<RevokeCollectionPluginAuthorityV1InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REVOKE_COLLECTION_PLUGIN_AUTHORITY_V1_DISCRIMINATOR })
  )
}
