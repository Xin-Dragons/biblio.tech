...
import { getPluginDecoder, getPluginEncoder, type Plugin, type PluginArgs } from "../types"
...
export type UpdateCollectionPluginV1InstructionData = { discriminator: number; plugin: Plugin }

export type UpdateCollectionPluginV1InstructionDataArgs = { plugin: PluginArgs }
...
export function getUpdateCollectionPluginV1InstructionDataEncoder(): Encoder<UpdateCollectionPluginV1InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: UPDATE_COLLECTION_PLUGIN_V1_DISCRIMINATOR })
  )
}
...
>(
  ...
  const getNextOptionalAccount = () => {
    ...
    return accountMeta.address === MPL_CORE_PROGRAM_PROGRAM_ADDRESS ? undefined : accountMeta
  }
  return {
