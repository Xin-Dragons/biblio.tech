...
export function getExecuteV1InstructionDataEncoder(): Encoder<ExecuteV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["instructionData", addEncoderSizePrefix(getBytesEncoder(), getU32Encoder())],
    ]),
...
export function getExecuteV1InstructionDataDecoder(): Decoder<ExecuteV1InstructionData> {
  return getStructDecoder([
    ...
    ["instructionData", addDecoderSizePrefix(getBytesDecoder(), getU32Decoder())],
  ])
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getExecuteV1InstructionDataEncoder().encode(args as ExecuteV1InstructionDataArgs),
    programAddress,
