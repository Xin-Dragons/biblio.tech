...
export type ExtraAccount =
  ...
  | { __kind: "PreconfiguredCollection"; isSigner: boolean; isWritable: boolean }
  ...
  | { __kind: "Address"; address: Address; isSigner: boolean; isWritable: boolean }
...
export function extraAccount(
  ...
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "PreconfiguredProgram">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "PreconfiguredProgram">
export function extraAccount(
  kind: "PreconfiguredCollection",
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "PreconfiguredCollection">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "PreconfiguredCollection">
export function extraAccount(
  kind: "PreconfiguredOwner",
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "PreconfiguredOwner">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "PreconfiguredOwner">
export function extraAccount(
  kind: "PreconfiguredRecipient",
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "PreconfiguredRecipient">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "PreconfiguredRecipient">
export function extraAccount(
  kind: "PreconfiguredAsset",
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "PreconfiguredAsset">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "PreconfiguredAsset">
export function extraAccount(
  kind: "CustomPda",
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "CustomPda">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "CustomPda">
export function extraAccount(
  kind: "Address",
  data: GetDiscriminatedUnionVariantContent<ExtraAccountArgs, "__kind", "Address">
): GetDiscriminatedUnionVariant<ExtraAccountArgs, "__kind", "Address">
export function extraAccount<K extends ExtraAccountArgs["__kind"], Data>(kind: K, data?: Data) {
