...
export type DataSectionInitInfo = { parentKey: LinkedDataKey; schema: ExternalPluginAdapterSchema }
...
export function getDataSectionInitInfoCodec(): Codec<DataSectionInitInfoArgs, DataSectionInitInfo> {
  return combineCodec(getDataSectionInitInfoEncoder(), getDataSectionInitInfoDecoder())
}
