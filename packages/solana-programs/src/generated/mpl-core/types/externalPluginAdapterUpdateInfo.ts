...
export type ExternalPluginAdapterUpdateInfo =
  ...
  | { __kind: "LinkedLifecycleHook"; fields: readonly [LinkedLifecycleHookUpdateInfo] }
...
export type ExternalPluginAdapterUpdateInfoArgs =
  ...
  | { __kind: "LinkedLifecycleHook"; fields: readonly [LinkedLifecycleHookUpdateInfoArgs] }
...
export function getExternalPluginAdapterUpdateInfoEncoder(): Encoder<ExternalPluginAdapterUpdateInfoArgs> {
  return getDiscriminatedUnionEncoder([
    [
      "LifecycleHook",
      getStructEncoder([["fields", getTupleEncoder([getLifecycleHookUpdateInfoEncoder()])]]),
    ],
    ["Oracle", getStructEncoder([["fields", getTupleEncoder([getOracleUpdateInfoEncoder()])]])],
    ["AppData", getStructEncoder([["fields", getTupleEncoder([getAppDataUpdateInfoEncoder()])]])],
    [
      "LinkedLifecycleHook",
      getStructEncoder([["fields", getTupleEncoder([getLinkedLifecycleHookUpdateInfoEncoder()])]]),
    ],
    [
      "LinkedAppData",
      getStructEncoder([["fields", getTupleEncoder([getLinkedAppDataUpdateInfoEncoder()])]]),
    ],
  ])
}
...
export function getExternalPluginAdapterUpdateInfoDecoder(): Decoder<ExternalPluginAdapterUpdateInfo> {
  return getDiscriminatedUnionDecoder([
    [
      "LifecycleHook",
      getStructDecoder([["fields", getTupleDecoder([getLifecycleHookUpdateInfoDecoder()])]]),
    ],
    ["Oracle", getStructDecoder([["fields", getTupleDecoder([getOracleUpdateInfoDecoder()])]])],
    ["AppData", getStructDecoder([["fields", getTupleDecoder([getAppDataUpdateInfoDecoder()])]])],
    [
      "LinkedLifecycleHook",
      getStructDecoder([["fields", getTupleDecoder([getLinkedLifecycleHookUpdateInfoDecoder()])]]),
    ],
    [
      "LinkedAppData",
      getStructDecoder([["fields", getTupleDecoder([getLinkedAppDataUpdateInfoDecoder()])]]),
    ],
  ])
}
...
export function externalPluginAdapterUpdateInfo(
  ...
  data: GetDiscriminatedUnionVariantContent<
    ...
    "LifecycleHook"
  >["fields"]
): GetDiscriminatedUnionVariant<ExternalPluginAdapterUpdateInfoArgs, "__kind", "LifecycleHook">
export function externalPluginAdapterUpdateInfo(
  kind: "Oracle",
  data: GetDiscriminatedUnionVariantContent<
    ExternalPluginAdapterUpdateInfoArgs,
    ...
    "Oracle"
  >["fields"]
): GetDiscriminatedUnionVariant<ExternalPluginAdapterUpdateInfoArgs, "__kind", "Oracle">
export function externalPluginAdapterUpdateInfo(
  kind: "AppData",
  data: GetDiscriminatedUnionVariantContent<
    ExternalPluginAdapterUpdateInfoArgs,
    ...
    "AppData"
  >["fields"]
): GetDiscriminatedUnionVariant<ExternalPluginAdapterUpdateInfoArgs, "__kind", "AppData">
export function externalPluginAdapterUpdateInfo(
...
export function externalPluginAdapterUpdateInfo(
  ...
  data: GetDiscriminatedUnionVariantContent<
    ...
    "LinkedAppData"
  >["fields"]
): GetDiscriminatedUnionVariant<ExternalPluginAdapterUpdateInfoArgs, "__kind", "LinkedAppData">
export function externalPluginAdapterUpdateInfo<
