...
export function getLinkedLifecycleHookCodec(): Codec<LinkedLifecycleHookArgs, LinkedLifecycleHook> {
  return combineCodec(getLinkedLifecycleHookEncoder(), getLinkedLifecycleHookDecoder())
}
