...
> {
  return combineCodec(getValidationResultsOffsetEncoder(), getValidationResultsOffsetDecoder())
}

// Data Enum Helpers.
export function validationResultsOffset(
  kind: "NoOffset"
): GetDiscriminatedUnionVariant<ValidationResultsOffsetArgs, "__kind", "NoOffset">
export function validationResultsOffset(
  kind: "Anchor"
): GetDiscriminatedUnionVariant<ValidationResultsOffsetArgs, "__kind", "Anchor">
export function validationResultsOffset(
  kind: "Custom",
  data: GetDiscriminatedUnionVariantContent<
    ...
    "Custom"
  >["fields"]
): GetDiscriminatedUnionVariant<ValidationResultsOffsetArgs, "__kind", "Custom">
export function validationResultsOffset<K extends ValidationResultsOffsetArgs["__kind"], Data>(
  kind: K,
  data?: Data
) {
...
export function isValidationResultsOffset<K extends ValidationResultsOffset["__kind"]>(
  kind: K,
