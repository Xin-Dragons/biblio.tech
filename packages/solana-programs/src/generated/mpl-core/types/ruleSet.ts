...
export function getRuleSetEncoder(): Encoder<RuleSetArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "ProgramAllowList",
      getStructEncoder([["fields", getTupleEncoder([getArrayEncoder(getAddressEncoder())])]]),
    ],
    [
      "ProgramDenyList",
      getStructEncoder([["fields", getTupleEncoder([getArrayEncoder(getAddressEncoder())])]]),
...
export function getRuleSetDecoder(): Decoder<RuleSet> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "ProgramAllowList",
      getStructDecoder([["fields", getTupleDecoder([getArrayDecoder(getAddressDecoder())])]]),
    ],
    [
      "ProgramDenyList",
      getStructDecoder([["fields", getTupleDecoder([getArrayDecoder(getAddressDecoder())])]]),
...
// Data Enum Helpers.
export function ruleSet(kind: "None"): GetDiscriminatedUnionVariant<RuleSetArgs, "__kind", "None">
export function ruleSet(
  kind: "ProgramAllowList",
  data: GetDiscriminatedUnionVariantContent<RuleSetArgs, "__kind", "ProgramAllowList">["fields"]
): GetDiscriminatedUnionVariant<RuleSetArgs, "__kind", "ProgramAllowList">
export function ruleSet(
  kind: "ProgramDenyList",
  data: GetDiscriminatedUnionVariantContent<RuleSetArgs, "__kind", "ProgramDenyList">["fields"]
): GetDiscriminatedUnionVariant<RuleSetArgs, "__kind", "ProgramDenyList">
export function ruleSet<K extends RuleSetArgs["__kind"], Data>(kind: K, data?: Data) {
