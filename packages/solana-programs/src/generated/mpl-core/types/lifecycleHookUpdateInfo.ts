...
export function getLifecycleHookUpdateInfoEncoder(): Encoder<LifecycleHookUpdateInfoArgs> {
  return getStructEncoder([
    [
      ...
      getOptionEncoder(
        getArrayEncoder(
          getTupleEncoder([getHookableLifecycleEventEncoder(), getExternalCheckResultEncoder()])
        )
      ),
    ],
    ["extraAccounts", getOptionEncoder(getArrayEncoder(getExtraAccountEncoder()))],
...
export function getLifecycleHookUpdateInfoDecoder(): Decoder<LifecycleHookUpdateInfo> {
  return getStructDecoder([
    [
      ...
      getOptionDecoder(
        getArrayDecoder(
          getTupleDecoder([getHookableLifecycleEventDecoder(), getExternalCheckResultDecoder()])
        )
      ),
    ],
    ["extraAccounts", getOptionDecoder(getArrayDecoder(getExtraAccountDecoder()))],
...
> {
  return combineCodec(getLifecycleHookUpdateInfoEncoder(), getLifecycleHookUpdateInfoDecoder())
}
