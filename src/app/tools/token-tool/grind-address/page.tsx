...
const Home = () => {
  ...
  return (
    <Stack>
      <Grid container spacing={4} alignItems="stretch" direction={{ xs: "column", sm: "row" }}>
        <Grid item xs={7}>
          <Card sx={{ height: "100%" }}>
            <CardContent>
        ...
        <Grid item xs={5}>
          <Card sx={{ height: "100%" }}>
            <CardContent>
              ...
              <br />
              <Typography>
                This is a client-side application, meaning the code only runs in your browser. We do not track, store or
                have access to any of your data or funds, including any keys generated using the application, any
            ...
            <Card>
              <CardContent>
                ...
                <Typography sx={{ paddingTop: "15px", fontSize: "13px", color: "#c75454" }}>
                  ...
                  address and any digital assets stored within. You will not receive a mnemonic, but you can download a
                  JSON file for your safekeeping.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
