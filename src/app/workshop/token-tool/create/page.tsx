...
export default function Create({ isAdmin }: { isAdmin: boolean }) {
        ...
        <CardContent>
          <Stack spacing={2}>
            ...
            <Typography variant="body1">
              ...
              <Button LinkComponent={Link} href="/tools/token-tool/grind-address">
                Grind Address
              </Button>{" "}
              tool, download the JSON keypair file, and upload below to create a vanity token.
            </Typography>
